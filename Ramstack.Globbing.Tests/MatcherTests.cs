...
public class MatcherTests
{
    ...
    [TestCase("{src,test{s,}}/*.cs",  "src/main.cs",           ExpectedResult = true)]
    [TestCase("{src,test{s,}}/*.cs",  "test/main.cs",          ExpectedResult = true)]
    [TestCase("{src,test{s,}}/*.cs",  "tests/main.cs",         ExpectedResult = true)]
    [TestCase("{src,test{s,}}/*.cs",  "test2/main.cs",         ExpectedResult = false)]
    [TestCase("{src,test{s,}}/*.cs",  "tests/main.c",          ExpectedResult = false)]
    [TestCase("{src,,test}/file.txt", "src/file.txt",          ExpectedResult = true)]
    [TestCase("{src,,test}/file.txt", "src/file.txt",          ExpectedResult = true)]
    [TestCase("{a,,b}1/file.txt",     "a1/file.txt",           ExpectedResult = true)]
    [TestCase("{a,,b}1/file.txt",     "b1/file.txt",           ExpectedResult = true)]
    [TestCase("{a,,b}1/file.txt",     "1/file.txt",            ExpectedResult = true)]
    [TestCase("{a,,b}1/file.txt",     "a/file.txt",            ExpectedResult = false)]
    [TestCase("{a,,b}1/file.txt",     "a1/readme.txt",         ExpectedResult = false)]
    [TestCase("{a,,b}1/file.txt",     "doc/file.txt",          ExpectedResult = false)]
    [TestCase("{[sS]rc,test*}/*.cs",  "src/app.cs",            ExpectedResult = true)]
    [TestCase("{[sS]rc,test*}/*.cs",  "src/app.cs",            ExpectedResult = true)]
    [TestCase("{[sS]rc,test*}/*.cs",  "Src/app.cs",            ExpectedResult = true)]
    [TestCase("{[sS]rc,test*}/*.cs",  "test/app.cs",           ExpectedResult = true)]
    [TestCase("{[sS]rc,test*}/*.cs",  "tests/app.cs",          ExpectedResult = true)]
